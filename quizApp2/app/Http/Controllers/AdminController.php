...
class AdminController extends Controller
{
    public function index()
    {
        ...
        return view('admin.index' , ['preguntas' => $preguntas,'respuestas' => $respuestas ]);
     ...
     */
        ...
        return view('admin.edit', ['pregunta' => $preguntas,
    ...
    public function update(Request $request, $id) {
        ...
        foreach ($request->respuesta as $key => $respuestaTexto) {
            $escorrecta = $key == $request->correcta;
    ...
    public function view(Request $request, admin $id) {
        $admin = Admin::find($id);
        if($admin == null) {
            return abort(404);
        }
